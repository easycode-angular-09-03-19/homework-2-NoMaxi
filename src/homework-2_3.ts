...
// 3. Есть два апи для получения и работы с новостями одно для получения новостей
// из USA, второе из Ukraine. Под эти апи создано по два интерфейса и по два класса.
// Переделайте это в namespaces. Код:
// // News api USA
// interface INews {
//     id: number;
//     title: string;
